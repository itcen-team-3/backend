...
public class LoggingAspect {
    ...
    @Pointcut("execution(* com.team_3.nursing_care.domain.member.controller.AdminController.*.*(..))")
    private void member_proxy_cut() {
    }

    @Around("care_log_proxy_cut() || geofence_proxy_cut() || member_proxy_cut()")
    ...
    @AfterThrowing(pointcut = "care_log_proxy_cut() || geofence_proxy_cut() || member_proxy_cut()", throwing = "exception")
