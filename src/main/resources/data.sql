...
INSERT INTO Member(company_id, member_name, phone_number, birth_date, address, profile_image, description, role, id, password)
VALUES(1, '김환자', '010-1111-1111', '2000-01-02', '과천시 아이티센', 'asdf', 'asdf', 'PATIENT', 'aaa', 'abc123');

INSERT INTO Member(company_id, member_name, phone_number, birth_date, address, profile_image, description, role, id, password)
VALUES(1, '이환자', '010-1111-1111', '2000-01-02', '과천시 아이티센', 'asdf', 'asdf', 'PATIENT', 'aaa', 'abc123');